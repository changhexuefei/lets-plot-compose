...
application {
    mainClass.set("probe.GraphiteRenderSurfaceProbeKt")
}

tasks.register<JavaExec>("graphiteRenderSurfaceProbe") {
    group = "verification"
    description = "Draws and reads back a Vulkan-backed Skiko Graphite surface on Windows."
